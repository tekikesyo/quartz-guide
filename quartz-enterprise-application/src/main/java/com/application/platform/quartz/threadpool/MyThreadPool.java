package com.application.platform.quartz.threadpool;
...
public class MyThreadPool implements ThreadPool {
    ...
    /**
     * <p>
     * Create a new (unconfigured) <code>MyThreadPool</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * Create a new <code>MyThreadPool</code> with the specified number
     ...
     */
    public MyThreadPool(int threadCount, int threadPriority) {
    ...
    public String getThreadNamePrefix() {
        if (threadNamePrefix == null) {
            threadNamePrefix = schedulerInstanceName + "-QuartzThreadGroupWorker";
        }
    ...
    public void initialize() throws SchedulerConfigException {
        ...
        threadGroup = new ThreadGroup("QuartzThreadGroup");
    ...
    protected List<WorkerThread> createWorkerThreads(int createCount) {
        ...
        for (int i = 1; i <= createCount; ++i) {
            WorkerThread wt = new WorkerThread(this, threadGroup, getThreadNamePrefix() + "-" + i, getThreadPriority(),
    ...
    class WorkerThread extends Thread {
         ...
         * </p>
         */
        WorkerThread(MyThreadPool tp, ThreadGroup threadGroup, String name, int prio, boolean isDaemon) {
